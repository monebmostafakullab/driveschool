    ...
    <div class="card card-primary">
        ...
        <form action="{{route('employees.store')}}" method="POST">
          ...
          <div class="card-body">
                ...
                <div class="row">
                            ...
                            <div class="form-group">
                                <select id="empl_category" name = "empl_category" class="form-control @error('empl_category') is-invalid @enderror">
                                    @foreach ($empl_categories as $empl_category)
                                            <option value="{{$empl_category->id}}" data-empcategorytype="{{$empl_category->type}}" @if ($empl_category->id == old('empl_category')) selected @endif>{{$empl_category->category_name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="d-flex flex-row">
                            ...
                            <div class="form-group">
                                <div class="input-group date" id="assignment_date" data-target-input="nearest">
                                    <input type="date" name="assignment_date" value="{{old('assignment_date')}}" class="form-control datetimepicker-input @error('assignment_date') is-invalid @enderror" data-target="#assignment_date"/>
                                    <div class="input-group-append" data-target="#DOB" data-toggle="datetimepicker">
                                        <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                    </div>
                                </div>
                    ...
                    <div class="col-4">
                        <div class="d-flex flex-row">
                            ...
                            <input type="text" value="{{old('sallary')}}" name="sallary" class="form-control @error('sallary') is-invalid @enderror" id="sallary" placeholder="ادخل الراتب">
                        </div>
                    </div>
                </div>
                <div class="row">
            ...
            <fieldset class="border p-2" id="trainingdata" >
                ...
                <div class="row">
                    <div class="col-4">
                        <div class="d-flex flex-row">
                            ...
                            <div class="col-7">
                                <input id="license_no" type="text" value="{{old('license_no')}}" name="license_no" class="form-control @error('license_no') is-invalid @enderror" id="cost" placeholder="رقم رخصة القيادة">
                            </div>
                        </div>
                    </div>
                    <div class="col-3">
                            ...
                            <div class="form-group col-8">
                                <select id="license_grade" name="license_grade" class="form-control @error('license_grade') is-invalid @enderror">
                                    @foreach ($grades as $grade)
                                        <option value="{{$grade->id}}" @if (old('license_grade') == $grade->id) selected @endif>{{$grade->grade_name}}</option>
                                    @endforeach
                                </select>
                            </div>   
                        </div>
                        ...
                        <div class="d-flex flex-row">
                            ...
                            <div class="form-group">
                                <div class="input-group date" id="license_expired_date" data-target-input="nearest">
                                    <input type="date" name="license_expired_date" value="{{old('license_expired_date')}}" class="form-control datetimepicker-input @error('license_expired_date') is-invalid @enderror" data-target="#license_expired_date"/>
                                    <div class="input-group-append" data-target="#DOB" data-toggle="datetimepicker">
                                        <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                    </div>
                                </div>
                ...
                <div class="row">
                    <div class="col-4">
                        <div class="d-flex flex-row">
                            ...
                            <div class="col-7">
                                <input id="t_license_no" type="text" value="{{old('t_license_no')}}" name="t_license_no" class="form-control @error('t_license_no') is-invalid @enderror" id="cost" placeholder="رقم رخصة التدريب">
                            </div>
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="d-flex flex-row">
                            ...
                            <div class="form-group col-8">
                                <select id="t_license_grade" name="t_license_grade" class="form-control @error('t_license_grade') is-invalid @enderror">
                                    @foreach ($grades as $grade)
                                        <option value="{{$grade->id}}" @if (old('t_license_grade') == $grade->id) selected @endif>{{$grade->grade_name}}</option>
                                    @endforeach
                                </select>
                            </div>   
                        </div>
                        ...
                        <div class="d-flex flex-row">
                            ...
                            <div class="form-group">
                                <div class="input-group date" id="t_license_expired_date" data-target-input="nearest">
                                    <input type="date" name="t_license_expired_date" value="{{old('t_license_expired_date')}}" class="form-control datetimepicker-input @error('t_license_expired_date') is-invalid @enderror" data-target="#t_license_expired_date"/>
                                    <div class="input-group-append" data-target="#DOB" data-toggle="datetimepicker">
                                        <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                    </div>
                                </div>
                ...
                <div class="d-flex flex-row">
                    ...
                    <div class="col-4">
                        @foreach ($training_types as $index => $training_type)
                            <div class="custom-control custom-checkbox">
                                <input class="custom-control-input" type="checkbox" @if(is_array(old('training_types')) && in_array($training_type->id, old('training_types'))) checked @endif name="training_types[]" id="{{$training_type->id}}" value="{{$training_type->id}}">
